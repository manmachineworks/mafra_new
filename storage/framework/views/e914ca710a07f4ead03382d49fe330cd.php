            ...
            <div class="aiz-topbar-item mr-3">
                <div class="d-flex align-items-center">
                    <button id="refresh_shiprocket_token" class="btn btn-topbar has-transition btn-icon btn-circle btn-light p-0 hov-bg-primary hov-svg-white d-flex align-items-center justify-content-center"
                        type="button" data-toggle="tooltip" data-title="<?php echo e(translate('Refresh Shiprocket Token')); ?>">
...
<script>
    (function() {
        ...
        var refreshEndpoint = "<?php echo e(route('shiprocket.token.refresh')); ?>";
        ...
        function doRefresh(showNotify) {
            ...
            $.post(refreshEndpoint, { _token: csrf })
                .done(function(resp) {
                    ...
                    if (showNotify !== false) {
                        AIZ.plugins.notify('success', resp.message || "<?php echo e(translate('Shiprocket token refreshed')); ?>");
                    }
                })
                .fail(function(xhr) {
                    var message = (xhr.responseJSON && xhr.responseJSON.message) ? xhr.responseJSON.message : "<?php echo e(translate('Failed to refresh Shiprocket token')); ?>";
                    if (showNotify !== false) {
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\wamp64\www\mafra_ind\resources\views/backend/inc/admin_nav.blade.php ENDPATH**/ ?>