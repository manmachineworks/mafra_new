...
<a href="javascript:void(0)" class="d-flex align-items-center <?php if(get_setting('header_element') !=6): ?> px-3 <?php endif; ?> h-100" data-toggle="dropdown" data-display="static"
    ...
    <?php else: ?>  
        ...
        <span class="d-none d-xl-block ml-1 fs-14 fw-700 bottom-text-color-visibility"
            style="color: <?php echo e(get_setting('bottom_header_text_color')); ?>">Cart</span>
...
<div class="dropdown-menu dropdown-menu-right dropdown-menu-lg p-0 stop-propagation rounded-0">
    ...
    <?php endif; ?>
</div><?php /**PATH C:\wamp64\www\mafra_ind\resources\views/frontend/partials/cart/cart.blade.php ENDPATH**/ ?>