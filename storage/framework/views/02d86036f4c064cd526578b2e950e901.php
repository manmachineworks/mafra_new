                        ...
                        <div class="position-relative h-140px h-md-200px img-fit overflow-hidden mb-3">
                            ...
                            <?php if( (is_array($colors) && count($colors) > 0) || (is_array($attributes) && count($attributes) > 0) ): ?>
                                <a class="cart-btn absolute-bottom-left w-100 h-35px aiz-p-hov-icon text-white fs-13 fw-700 d-none d-sm-flex flex-column justify-content-center align-items-center"
                                    href="javascript:void(0)" onclick="showAddToCartModal(<?php echo e($wishlist->product->id); ?>)">
...
<?php echo $__env->make('frontend.layouts.user_panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\mafra_ind\resources\views/frontend/user/customer/dashboard.blade.php ENDPATH**/ ?>