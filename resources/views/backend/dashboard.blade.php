...
@push('css')
<style>
    .dashboard-skin { background:#ffffff; }
    ...
    .kpi-value { font-size:22px; font-weight:700; color:#212121; }
    .kpi-label { font-size:12px; color:#6b7280; }
    .btn-action { background:#c70a0a; color:#fff; border-radius:20px; padding:8px 14px; }
